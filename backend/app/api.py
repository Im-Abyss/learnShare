...
@app.post('/courses/{course_id}/disciplines/add', 
         tags=['Пользовательская панель'], 
...
@app.delete('/courses/{course_id}/disciplines/{discipline_id}/delete', 
         tags=['Пользовательская панель'], 
...
@app.delete('/disciplines/{disciplines_id}/posts/{posts_id}/delete',
          tags=['Пользовательская панель'], 
